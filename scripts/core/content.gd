...
const PARTS := {
	...
	"jet": {"name": "Реактивный мешок", "kind": "move", "cost": 35, "dash_k": 0.6,
...
const SPECIES := {
	...
	"malki": {"name": "Мальки", "behavior": "grazer", "radius": 7.0, "color": "#bfe8a0", "shape": "oval", "tier": 0, "school": 7,
		"parts": [["filter", 0, 1], ["cilia", 180, 1]], "levels": [1, 10], "weight": 2.0, "biomes": ["shallows"],
		"drops": [["cilia", 0.1]], "hint": "Плавают стаей и разбегаются веером"},
	"zubastiki": {"name": "Зубастики", "behavior": "hunter", "radius": 9.0, "color": "#e07070", "shape": "drop", "tier": 1, "school": 5, "aggro": true,
		"parts": [["jaws", 0, 1], ["cilia", 180, 1]], "levels": [3, 9], "weight": 1.3, "biomes": ["shallows", "deep"],
		"drops": [["jaws", 0.12]], "hint": "Охотятся стаей — одного не боятся, стаи бойся"},
	...
	"ostrozub": {"name": "Острозуб", "behavior": "hunter", "radius": 12.0, "color": "#e0806a", "shape": "drop", "tier": 2, "aggro": true,
		"parts": [["jaws", 0, 1], ["flagellum", 180, 1]], "levels": [1, 5], "weight": 2.2,
	...
	"chernilnik": {"name": "Чернильник", "behavior": "skittish", "radius": 16.0, "color": "#5a4a7a", "shape": "bean", "tier": 2,
		"parts": [["ink", 90, 1], ["filter", 0, 1], ["flagellum", 180, 1]], "levels": [3, 10], "weight": 1.5, "biomes": ["deep", "cold"],
		"drops": [["ink", 0.3], ["flagellum", 0.1]], "hint": "Удирая, пускает чернила"},
	"udilshik": {"name": "Удильщик", "behavior": "hunter", "radius": 24.0, "color": "#3a4a70", "shape": "wide", "tier": 4,
		"parts": [["fangs", 0, 1], ["lantern", -30, 1], ["cilia", 150, 1], ["cilia", -150, 1]], "levels": [4, 10], "weight": 1.2, "biomes": ["deep"],
		"drops": [["fangs", 0.2]], "hint": "Светится огоньком во тьме. Огонёк не выбить"},
	# Горячие источники.
	...
	"koroleva": {"name": "Королева глубин", "behavior": "lair", "radius": 16.0, "scale": 2.8, "color": "#6a4a9a", "shape": "blob", "tier": 9, "hunts": true,
		"parts": [["fangs", 0, 2], ["life_core", 180, 1], ["tentacle", 60, 1], ["tentacle", -60, 1], ["membrane", 150, 2], ["membrane", -150, 2], ["eye", 30, 1], ["eye", -30, 1]],
		"levels": [3, 10], "weight": 0.0, "biomes": ["deep"], "drops": [["life_core", 1.0], ["fangs", 0.4]],
		"minions": "zubastiki", "hint": "Хозяйка логова в глубине. На середине сил зовёт стаю. Награда — ядро жизни"},
	"strazh": {"name": "Колючий страж", "behavior": "lair", "radius": 16.0, "scale": 2.6, "color": "#b0603a", "shape": "star", "tier": 9, "hunts": true,
		"parts": [["horn", 0, 2], ["thorn_armor", 90, 1], ["thorn_armor", -90, 1], ["spike2", 150, 1], ["spike2", -150, 1], ["thermo", 180, 1]],
		"levels": [4, 10], "weight": 0.0, "biomes": ["hot"], "drops": [["thorn_armor", 1.0], ["spike2", 0.4]],
		"minions": "ognevik", "hint": "Хозяин логова в горячих источниках. Награда — шипастая броня"},
	"vikhr": {"name": "Ледяной вихрь", "behavior": "lair", "radius": 16.0, "scale": 2.4, "color": "#9ad0f0", "shape": "drop", "tier": 9, "hunts": true,
		"parts": [["jaws", 0, 3], ["jet", 180, 1], ["flagellum2", 150, 1], ["flagellum2", -150, 1], ["fat", 0, 1]],
		"levels": [3, 10], "weight": 0.0, "biomes": ["cold"], "drops": [["jet", 1.0], ["flagellum2", 0.3]],
