...
const PARTS := {
	...
	"spit": {"name": "Плевательная железа", "kind": "weapon", "cost": 30, "arc": 35, "gun": "spit", "range": 320.0, "reload": 2.4, "dmg": 2.0, "poison": 2.0,
		"hint": "Плюётся ядом во врага впереди — сама, издалека. У плевунов"},
	"needle": {"name": "Игломёт", "kind": "weapon", "cost": 34, "arc": 30, "gun": "needle", "range": 380.0, "reload": 1.8, "dmg": 5.0,
		"hint": "Стреляет иглами во врага впереди — сама, издалека. У иглострелов"},
