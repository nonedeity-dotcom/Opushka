...
func rebuild() -> void:
	...
	_toggle(col, "Мини-карта", "Круг в углу: еда, логова, гиганты и опасные вокруг", "minimap")
	_choice(col, "Остров (суша)", "land_quality", [["fast", "Быстро"], ["normal", "Обычно"], ["best", "Красиво"]])
